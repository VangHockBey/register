...
.setColor("RANDOM")
.setDescription(`<a:jesteria_dans:887018170962042960> ${etiketlenenKişi} kullanıcısının
...
exports.config = {
    name: "teyit",
    guildOnly: true,
    aliases: ["teyit-bilgi", "teyitbilgi", "teyitler", "teyit-sayi", "teyitsayi", "teyitsayisi", "teyit-sayisi", "kayit-bilgi", "kayitbilgi", "kayitlar", "kayit-sayi", "kayitsayi", "kayit-sayisi", "kayitsayisi","profil","profile"]
  }